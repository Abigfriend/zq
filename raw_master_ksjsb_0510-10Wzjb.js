...
IOS/安卓： 快手极速版榨干版
申明：请勿传播，发现传播直接删库！！！
0510版本更新，内置热心网友的看广告json，使用本人仓库，一般不会出现无法获取的情况。
13:00之前跑990金币+990金币（预计跑完5-6次后0金币）
13:00以后跑213金币+213金币（13点前的0金币后可跑这个）
四组广告数据混合，提升收益的同时还降低黑号风险。
预计日收益10w金币。
快手极速版CK变量ksjsbCookie
export ksjsbCookie="kuaishou.api_st=xxxxxx"多账号@连接
重写：
[task_local]
#快手极速版
[rewrite_local]
...
let _0x134a17 = new Date(),
    ...
    _0x2e716e = 0,
    _0x5bc515 = "ksjsb",
    _0x180c0c = "https://yunliu23.coding.net/p/kele/d/kele/git/raw/master/kszl.json",//更改的生孩子没屁眼子
    ksjsbjk = "https://yunliu23.coding.net/p/kele/d/kele/git/raw/master/ksgg.json",//广告json
  ...
  if (p[_0x5bc515]) {
    ...
    if (a["status"] == 0) {
      if (_0x459e63 >= a["version"]) {
        _0x2e716e = true;
        _0x75eec0 = "https://yunliu23.coding.net/p/kele/d/kele/git/raw/master/kszl.json";
...
function Envcc(T, c) {
  const p = {
    ...
    'dceom': 'ijzfe',
    'JighY': 'updateMsg',
    'uwDzR': "https://yunliu23.coding.net/p/kele/d/kele/git/raw/master/kszl.json",
    'CvmUM': function (S, a) {
      return S === a;
    },
    'QfLFC': "JwVvM",
    ...
    [p["QrmhW"]](S, a) {
      if (p["JpIGP"]('ViWHE', p["NOwog"])) {
        if (p["QwtqA"](q, i[p["LTEld"]])) {
          d = true;
          u = "https://yunliu23.coding.net/p/kele/d/kele/git/raw/master/kszl.json";
